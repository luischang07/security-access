  ...
  <div class="max-w-7xl mx-auto">
    ...
    <?php if(session('order_success')): ?>
      <div class="mb-6 rounded-lg border border-success/30 bg-success/10 text-success px-4 py-3 flex items-center gap-3">
        ...
        <div class="flex flex-col">
          ...
          <span class="text-sm text-success/90">Te avisaremos cuando esté listo para recolección. A continuación los
            detalles de tu pedido.</span>
        </div>
      </div>
    <?php endif; ?>
    ...
    <section class="mb-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Order Date -->
        <div
          class="rounded-lg border border-border-light dark:border-border-dark shadow-sm bg-card-light dark:bg-card-dark p-6">
                  ...
                  <?php if($lineas && count($lineas) > 0): ?>
                    <?php $__currentLoopData = $lineas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $linea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <tr>
                        ...
                        <td
                          class="whitespace-nowrap px-3 py-4 text-sm text-neutral-text dark:text-neutral-text-dark text-right font-medium">
                    ...
                    <tr
                      class="border-t-2 border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark">
                      <td colspan="3"
                        class="py-4 pl-4 pr-3 text-sm text-right font-bold text-body-text dark:text-body-text-dark sm:pl-0">
    ...
    <section class="flex justify-start items-center gap-4 mb-8">
      <a href="<?php echo e(route('patient.orders')); ?>"
...
<?php if(session('order_success')): ?>
  ...
  <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.patient-spa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/franciscomejia/Documents/PROYECTOS TEC/Te-Acerco-Salud/resources/views/patient/order-detail.blade.php ENDPATH**/ ?>
    ...
    <div class="px-4 sm:px-10 lg:px-20 mx-auto">
      <div
        ...
        <a href="<?php echo e(route('landing')); ?>"
          ...
          <h2 class="text-xl font-bold leading-tight tracking-[-0.015em]"><?php echo e(__('common.brand')); ?></h2>
        </a>
  ...
  <header
    ...
    <div class="px-4 sm:px-10 lg:px-20 mx-auto">
      <div
        ...
        <a href="<?php echo e(route('landing')); ?>"
          class="flex items-center gap-4 text-gray-900 dark:text-white hover:opacity-80 transition-opacity">
          <div class="size-6 text-primary" aria-hidden="true">
            <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 4H17.3334V17.3334H30.6666V30.6666H44V44H4V4Z" fill="currentColor"></path>
            </svg>
          </div>
          <h2 class="text-lg font-bold leading-tight tracking-[-0.015em]"><?php echo e(__('common.brand')); ?></h2>
        </a>
...
<?php endif; ?><?php /**PATH /Users/franciscomejia/Documents/PROYECTOS TEC/Te-Acerco-Salud/resources/views/components/navbar.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <title><?php echo e(__('pharmacy.inventory.title')); ?> - Te Acerco Salud</title>
                    ...
                    <div class="mx-auto max-w-7xl space-y-6">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <h1
                                ...
                                <?php echo e(__('pharmacy.inventory.title')); ?>
                            ...
                            <button
                                ...
                                <?php echo e(__('pharmacy.inventory.add_new_medication')); ?>
                        ...
                        <div
                            ...
                            <div class="relative flex-1 w-full">
                                ...
                                <input type="text" placeholder="<?php echo e(__('pharmacy.inventory.search_placeholder')); ?>"
                            ...
                            <div class="flex flex-wrap gap-2">
                                <button
                                    class="px-4 py-2 rounded-lg bg-primary text-white text-sm font-medium"><?php echo e(__('pharmacy.inventory.filter_all')); ?></button>
                                <button
                                    class="px-4 py-2 rounded-lg text-body-text dark:text-body-text-dark border border-border-light dark:border-border-dark hover:bg-background-light dark:hover:bg-background-dark text-sm font-medium"><?php echo e(__('pharmacy.inventory.filter_low_stock')); ?></button>
                                <button
                                    class="px-4 py-2 rounded-lg text-body-text dark:text-body-text-dark border border-border-light dark:border-border-dark hover:bg-background-light dark:hover:bg-background-dark text-sm font-medium"><?php echo e(__('pharmacy.inventory.filter_out_of_stock')); ?></button>
                            </div>
                        </div>
                        ...
                        <div
                                    ...
                                    <thead class="bg-background-light dark:bg-background-dark">
                                        <tr>
                                            ...
                                            <th
                                                ...
                                                <?php echo e(__('pharmacy.inventory.medication_info')); ?></th>
                                            <th
                                                class="py-4 px-6 text-left text-sm font-bold text-body-text dark:text-body-text-dark">
                                                <?php echo e(__('pharmacy.inventory.product_code')); ?></th>
                                            <th
                                                class="py-4 px-6 text-left text-sm font-bold text-body-text dark:text-body-text-dark">
                                                <?php echo e(__('pharmacy.inventory.current_stock')); ?></th>
                                            <th
                                                class="py-4 px-6 text-left text-sm font-bold text-body-text dark:text-body-text-dark">
                                                <?php echo e(__('pharmacy.inventory.min_max_stock')); ?></th>
                                            <th
                                                class="py-4 px-6 text-left text-sm font-bold text-body-text dark:text-body-text-dark">
                                                <?php echo e(__('pharmacy.inventory.unit_price')); ?></th>
                                            <th
                                                class="py-4 px-6 text-left text-sm font-bold text-body-text dark:text-body-text-dark">
                                                <?php echo e(__('pharmacy.inventory.status')); ?></th>
                                            <th
                                                class="py-4 px-6 text-right text-sm font-bold text-body-text dark:text-body-text-dark">
                                                <?php echo e(__('pharmacy.inventory.actions')); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y divide-border-light dark:divide-border-dark">
                                        ...
                                        <?php $__currentLoopData = $medications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $med): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="hover:bg-background-light dark:hover:bg-background-dark/50">
                                                ...
                                                <td class="py-4 px-6 text-neutral-text dark:text-neutral-text-dark">
                                                    <?php echo e($med['min']); ?> / <?php echo e($med['max']); ?></td>
                                                <td class="py-4 px-6 text-neutral-text dark:text-neutral-text-dark">
                                                    $<?php echo e(number_format($med['price'], 2)); ?></td>
                                                <td class="py-4 px-6">
                                                    <?php if($med['status'] === 'in_stock'): ?>
                                                        <span
                                                            ...
                                                            <?php echo e(__('pharmacy.inventory.stock_status.in_stock')); ?>
                                                    ...
                                                    <?php elseif($med['status'] === 'low_stock'): ?>
                                                        <span
                                                            ...
                                                            <?php echo e(__('pharmacy.inventory.stock_status.low_stock')); ?>
                                                    ...
                                                    <?php else: ?>
                                                        <span
                                                            ...
                                                            <?php echo e(__('pharmacy.inventory.stock_status.out_of_stock')); ?>
                                                ...
                                                <td class="py-4 px-6">
                                                    <?php if($med['editing']): ?>
                                                        <div class="flex justify-end gap-2">
                                                            <button
                                                                class="px-3 py-2 rounded-lg bg-success text-white text-sm font-semibold hover:bg-success/90"><?php echo e(__('pharmacy.inventory.save')); ?></button>
                                                            <button
                                                                class="px-3 py-2 rounded-lg bg-neutral-text/20 text-body-text dark:text-body-text-dark text-sm font-semibold hover:bg-neutral-text/30"><?php echo e(__('pharmacy.inventory.cancel')); ?></button>
                                                        </div>
                                                    <?php else: ?>
                                                        <div class="flex justify-end gap-2">
                                                            <button
                            ...
                            <div
                                ...
                                <span
                                    class="text-sm text-neutral-text dark:text-neutral-text-dark"><?php echo e(__('pharmacy.inventory.showing_results', ['from' => 1, 'to' => 4, 'total' => 27])); ?></span>
...
<?php /**PATH /Users/franciscomejia/Documents/PROYECTOS TEC/Te-Acerco-Salud/resources/views/pharmacy/inventory.blade.php ENDPATH**/ ?>
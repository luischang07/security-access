...
<head>
    ...
    <title><?php echo e(__('pharmacy.dashboard.title')); ?> - Te Acerco Salud</title>
                    ...
                    <div class="mx-auto max-w-7xl space-y-8">
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <h1
                                ...
                                <?php echo e(__('pharmacy.dashboard.title')); ?>
                            ...
                            <div class="flex flex-wrap gap-3">
                                <button
                                    ...
                                    <span class="truncate"><?php echo e(__('pharmacy.dashboard.new_order')); ?></span>
                                </button>
                                <button
                                    ...
                                    <span class="truncate"><?php echo e(__('pharmacy.dashboard.export_report')); ?></span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                            <div
                                ...
                                <div class="flex justify-between items-center">
                                    <p class="text-base font-medium text-neutral-text dark:text-neutral-text-dark">
                                        <?php echo e(__('pharmacy.dashboard.pending_orders')); ?></p>
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-center">
                                    <p class="text-base font-medium text-neutral-text dark:text-neutral-text-dark">
                                        <?php echo e(__('pharmacy.dashboard.completed_today')); ?></p>
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-center">
                                    <p class="text-base font-medium text-neutral-text dark:text-neutral-text-dark">
                                        <?php echo e(__('pharmacy.dashboard.revenue_today')); ?></p>
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-center">
                                    <p class="text-base font-medium text-neutral-text dark:text-neutral-text-dark">
                                        <?php echo e(__('pharmacy.dashboard.low_stock_items')); ?></p>
                                ...
                                <p class="text-sm font-medium text-danger">
                                    <?php echo e(__('pharmacy.dashboard.requires_attention')); ?></p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <h2 class="text-xl font-bold text-body-text dark:text-body-text-dark">
                                    <?php echo e(__('pharmacy.dashboard.recent_orders')); ?></h2>
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h3 class="font-bold text-body-text dark:text-body-text-dark">Order
                                                        #TAS-<?php echo e(1000 + $i); ?></h3>
                                                    <p class="text-sm text-neutral-text dark:text-neutral-text-dark">
                                                        Patient <?php echo e($i); ?> - <?php echo e($i); ?> items</p>
                                                </div>
                                            </div>
                                            <div class="text-right">
                                                <span
                                                    class="inline-flex items-center rounded-full px-3 py-1 text-xs font-medium
                                                <?php if($i == 1): ?> bg-warning/20 text-warning
                                                <?php elseif($i == 2): ?> bg-success/20 text-success
                                                <?php else: ?> bg-primary/20 text-primary <?php endif; ?>">
                                                    <?php if($i == 1): ?>
                                                        <?php echo e(__('pharmacy.orders.status.pending')); ?>

                                                    <?php elseif($i == 2): ?>
                                                        <?php echo e(__('pharmacy.orders.status.ready')); ?>

                                                    <?php else: ?>
                                                        <?php echo e(__('pharmacy.orders.status.processing')); ?>
...
<?php /**PATH /Users/franciscomejia/Documents/PROYECTOS TEC/Te-Acerco-Salud/resources/views/pharmacy/dashboard.blade.php ENDPATH**/ ?>
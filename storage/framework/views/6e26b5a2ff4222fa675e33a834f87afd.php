<div class="max-w-5xl mx-auto">
  ...
  <?php if(session('success')): ?>
    <div
      ...
      <p class="text-green-800 dark:text-green-200 text-sm font-medium"><?php echo e(session('success')); ?></p>
    </div>
  <?php endif; ?>

  <?php if(session('error')): ?>
    <div class="alert-message mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
      <p class="text-red-800 dark:text-red-200 text-sm font-medium"><?php echo e(session('error')); ?></p>
    </div>
  <?php endif; ?>
  ...
  <?php if($errors->any()): ?>
    <div class="alert-message mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
      <p class="text-red-800 dark:text-red-200 text-sm font-bold mb-2">
        <?php echo e(__('patient.profile.messages.validation_error')); ?>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div
        ...
        <div class="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-800">
          <h2 class="text-gray-900 dark:text-white text-xl font-bold">
            <?php echo e(__('patient.profile.personal_info.title')); ?>
          ...
          <button type="button" id="edit-profile-btn"
            ...
            <span><?php echo e(__('patient.profile.edit_profile')); ?></span>
          </button>
        </div>
        ...
        <div id="profile-display-mode" class="p-6 space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <p class="text-gray-500 dark:text-gray-400 text-sm font-medium mb-1">
                <?php echo e(__('patient.profile.personal_info.first_name')); ?>
            ...
            <div>
              <p class="text-gray-500 dark:text-gray-400 text-sm font-medium mb-1">
                <?php echo e(__('patient.profile.personal_info.last_name')); ?>
          ...
          <div>
            <p class="text-gray-500 dark:text-gray-400 text-sm font-medium mb-1">
              <?php echo e(__('patient.profile.personal_info.email')); ?>
        ...
        <div id="profile-edit-mode" class="hidden p-6">
          <form id="profile-form" method="POST" action="<?php echo e(route('patient.profile.update')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" id="nombre" name="nombre" value="<?php echo e(old('nombre', $user->nombre)); ?>" required
                    ...
                    placeholder="<?php echo e(__('patient.profile.placeholders.first_name')); ?>">
                </div>
                <div>
                  ...
                  <input type="text" id="apellido" name="apellido" value="<?php echo e(old('apellido', $user->apellido)); ?>"
                    required
                    class="w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:border-primary focus:ring-primary/50"
                    placeholder="<?php echo e(__('patient.profile.placeholders.last_name')); ?>">
                </div>
              </div>
              ...
              <div>
                ...
                <input type="email" id="correo" name="correo" value="<?php echo e(old('correo', $user->correo)); ?>" required
                  class="w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:border-primary focus:ring-primary/50"
                  placeholder="<?php echo e(__('patient.profile.placeholders.email')); ?>">
              </div>
              ...
              <div class="flex gap-3 pt-4">
                <button type="submit"
                  ...
                  <span><?php echo e(__('patient.profile.save_changes')); ?></span>
                </button>
                <button type="button" id="cancel-edit-btn"
                  ...
                  <span><?php echo e(__('patient.profile.cancel')); ?></span>
                </button>
              </div>
            </div>
          </form>
    ...
    <section>
      <div
        ...
        <h2 class="text-gray-900 dark:text-white text-xl font-bold">
          <?php echo e(__('patient.profile.account_stats.title')); ?>
        ...
        <div class="space-y-4">
          <div class="flex justify-between items-center">
            <p class="text-gray-500 dark:text-gray-400 text-sm">
              <?php echo e(__('patient.profile.account_stats.total_orders')); ?>

            </p>
            <p class="text-gray-900 dark:text-white font-bold text-lg"><?php echo e($totalOrders); ?></p>
          </div>

          <div class="flex justify-between items-center">
            <p class="text-gray-500 dark:text-gray-400 text-sm">
              <?php echo e(__('patient.profile.account_stats.active_penalties')); ?>

            </p>
            <p
              class="text-<?php echo e($activePenalties > 0 ? 'red' : 'gray'); ?>-900 dark:text-<?php echo e($activePenalties > 0 ? 'red' : 'white'); ?>-500 font-bold text-lg">
              <?php echo e($activePenalties); ?>
          ...
          <div class="border-t border-gray-200 dark:border-gray-800 pt-4">
            <p class="text-gray-500 dark:text-gray-400 text-sm mb-1">
              <?php echo e(__('patient.profile.account_stats.member_since')); ?>
          ...
          <div>
            <p class="text-gray-500 dark:text-gray-400 text-sm mb-1">
              <?php echo e(__('patient.profile.account_stats.last_login')); ?>

            </p>
            <p class="text-gray-900 dark:text-white font-semibold">
              <?php echo e($user->ultimo_login ? $user->ultimo_login->format('d/m/Y H:i') : 'N/A'); ?>

            </p>
          </div>
        </div>

        <?php if($activePenalties > 0): ?>
          <a href="<?php echo e(route('patient.penalties')); ?>"
            ...
            <?php echo e(__('patient.dashboard.penalty.view_details')); ?>
...
<?php echo app('Illuminate\Foundation\Vite')(['resources/js/patient/profile.js']); ?><?php /**PATH /Users/franciscomejia/Documents/PROYECTOS TEC/Te-Acerco-Salud/resources/views/patient/partials/profile-content.blade.php ENDPATH**/ ?>
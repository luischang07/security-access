        ...
        <?php $__currentLoopData = $pedidosCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div
            ...
            <div class="flex items-center justify-between w-full sm:w-auto gap-4">
              ...
              <a href="<?php echo e(route('patient.orders.show', $pedido->getFolio())); ?>"
      ...
      <?php else: ?>
        <div
          ...
          <p class="text-neutral-text dark:text-neutral-text-dark">
            <?php echo e(__('patient.orders.no_orders') ?? 'No hay pedidos para mostrar.'); ?>
...
</div><?php /**PATH C:\xampp\htdocs\laravel\securityAccess\security-access\resources\views/patient/partials/orders-content.blade.php ENDPATH**/ ?>
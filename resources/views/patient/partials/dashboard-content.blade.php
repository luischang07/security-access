    ...
    <div class="flex flex-wrap justify-between items-center gap-4 mb-8">
        <div class="flex min-w-72 flex-col gap-2">
            <p class="text-gray-900 dark:text-white text-3xl sm:text-4xl font-black leading-tight tracking-[-0.033em]">
                {{ __('patient.dashboard.welcome', ['name' => $user->name]) }}
            </p>
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-900 dark:text-white font-semibold mt-1">
                            {{ __('patient.dashboard.active_orders.awaiting_confirmation') }}
                        </p>
                    </div>
                    ...
                    <a class="text-primary font-bold text-sm whitespace-nowrap"
                        href="#">{{ __('patient.dashboard.active_orders.view_details') }}</a>
                </div>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 py-4">
                    <div class="flex-1">
                        ...
                        <p class="text-gray-900 dark:text-white font-semibold mt-1">
                            {{ __('patient.dashboard.active_orders.ready_for_pickup') }}
                        </p>
                    </div>
                    <div class="flex-1 w-full">
                        <div class="relative w-full h-2 bg-gray-200 dark:bg-gray-700 rounded-full">
                        ...
                        <div
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-gray-500 dark:text-gray-400 text-xs">
                                    {{ __('patient.dashboard.recent_history.completed') }}</p>
                            </div>
                            <a href="#"
                                class="text-primary text-sm font-medium whitespace-nowrap">{{ __('common.actions.view') }}</a>
                        </div>
                    @endfor
                    <div class="p-4 text-center">
                        <a href="{{ route('patient.orders') }}" class="text-primary font-bold text-sm">

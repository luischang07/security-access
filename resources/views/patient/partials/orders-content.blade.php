<div class="max-w-7xl mx-auto">
  ...
  <section>
    ...
    <div class="space-y-3">
        ...
        @foreach($pedidosCollection as $pedido)
          ...
          <div
            ...
            <div class="flex items-center justify-between w-full sm:w-auto gap-4">
              ...
              <a href="{{ route('patient.orders.show', $pedido->getFolio()) }}"
      ...
      @else
        <div
          class="rounded-lg border border-border-light dark:border-border-dark shadow-sm bg-card-light dark:bg-card-dark p-6 text-center">
          <p class="text-neutral-text dark:text-neutral-text-dark">
            {{ __('patient.orders.no_orders') ?? 'No hay pedidos para mostrar.' }}
          </p>
        </div>
      @endif
    </div>

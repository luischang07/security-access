<div class="max-w-7xl mx-auto">
    ...
    <section class="mb-10">
        <h2 class="text-body-text dark:text-body-text-dark text-xl font-bold leading-tight tracking-[-0.015em] mb-4">
            {{ __('patient.orders.current_order') }}
        </h2>
        <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col items-center relative">
                        ...
                        <p class="text-xs font-medium text-center mt-2">
                            {{ __('patient.orders.status.pending') }}</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center relative">
                        ...
                        <p class="text-xs font-medium text-center mt-2">
                            {{ __('patient.orders.status.in_process') }}</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center relative">
                        ...
                        <p class="text-xs font-bold text-center mt-2 text-warning">
                            {{ __('patient.orders.status.ready') }}</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center relative">
                        ...
                        <p class="text-xs font-medium text-center mt-2 text-neutral-text dark:text-neutral-text-dark">
                            {{ __('patient.orders.status.completed') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div>
                    <p class="text-base font-bold text-body-text dark:text-body-text-dark">
                        {{ __('patient.orders.estimated_collection') }}: Today at 4:30 PM
                    </p>
                    <p class="text-sm text-neutral-text dark:text-neutral-text-dark">
                ...
                <button
                    ...
                    <span class="truncate">{{ __('patient.orders.view_details') }}</span>
                </button>
            </div>
        </div>
    </section>
    ...
    <section>
        <h2 class="text-body-text dark:text-body-text-dark text-xl font-bold leading-tight tracking-[-0.015em] mb-4">
            {{ __('patient.orders.order_history') }}
        </h2>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-4">
            <div class="relative w-full sm:max-w-xs">
                ...
                <input
                    ...
                    placeholder="{{ __('patient.orders.search_placeholder') }}" type="text" />
            </div>
            <div class="flex items-center gap-2 w-full sm:w-auto">
                <select
                    ...
                    <option>{{ __('patient.orders.filter_by_status') }}</option>
                    <option>{{ __('patient.orders.status.collected') }}</option>
                    <option>{{ __('patient.orders.status.cancelled') }}</option>
                </select>
                <input
                    class="w-full sm:w-auto h-10 px-3 rounded-lg border border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark focus:ring-primary focus:border-primary"
                    type="date" />
        ...
        <div class="space-y-3">
            ...
            <div
                ...
                <div class="flex-1 w-full">
                    <p class="text-sm text-neutral-text dark:text-neutral-text-dark">
                        {{ __('patient.orders.order_id') }}: TAS-1098-7654
                    </p>
                    <p class="text-base font-bold text-body-text dark:text-body-text-dark">
            ...
            <div
                ...
                <div class="flex-1 w-full">
                    <p class="text-sm text-neutral-text dark:text-neutral-text-dark">
                        {{ __('patient.orders.order_id') }}: TAS-1097-1234
                    </p>
                    <p class="text-base font-bold text-body-text dark:text-body-text-dark">
                        Amoxicillin 250mg
                    </p>
            ...
            <div
                ...
                <div class="flex-1 w-full">
                    <p class="text-sm text-neutral-text dark:text-neutral-text-dark">
                        {{ __('patient.orders.order_id') }}: TAS-1095-5566
                    </p>
                    <p class="text-base font-bold text-body-text dark:text-body-text-dark">
                        Aspirin 81mg
                    </p>

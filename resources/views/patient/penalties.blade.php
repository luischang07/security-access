...
@section('title', __('patient.penalties.title'))
                ...
                <div class="flex flex-wrap justify-between gap-4 items-start mb-8">
                    ...
                    <div class="flex gap-2 flex-wrap">
                        <button
                            ...
                            {{ __('patient.penalties.read_policy') }}
                        </button>
                        <button
                            ...
                            {{ __('patient.penalties.contact_support') }}
                        </button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    <div
                        ...
                        <p class="text-body-text dark:text-body-text-dark text-base font-medium leading-normal">
                            {{ __('patient.penalties.total_penalties') }}
                        </p>
                    ...
                    <div
                        class="flex flex-col gap-2 rounded-xl p-6 border border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark">
                        <p class="text-body-text dark:text-body-text-dark text-base font-medium leading-normal">
                            {{ __('patient.penalties.total_amount_due') }}
                        </p>
                ...
                <div class="bg-card-light dark:bg-card-dark rounded-xl border border-border-light dark:border-border-dark">
                    ...
                    <div
                        ...
                        <p class="text-lg font-semibold text-body-text dark:text-body-text-dark">
                            {{ __('patient.penalties.penalty_record') }}
                        </p>
                                ...
                                <thead>
                                    <tr class="border-b border-border-light dark:border-border-dark">
                                        <th
                                            ...
                                            {{ __('patient.penalties.date') }}
                                        </th>
                                        <th
                                            class="px-4 py-3 text-left text-neutral-text dark:text-neutral-text-dark text-sm font-medium leading-normal">
                                            {{ __('patient.penalties.reason') }}
                                        </th>
                                        <th
                                            class="px-4 py-3 text-left text-neutral-text dark:text-neutral-text-dark text-sm font-medium leading-normal">
                                            {{ __('patient.penalties.order_number') }}
                                        </th>
                                        <th
                                            class="px-4 py-3 text-left text-neutral-text dark:text-neutral-text-dark text-sm font-medium leading-normal">
                                            {{ __('patient.penalties.consequence') }}
                                        </th>
                                        <th
                                            class="px-4 py-3 text-left text-neutral-text dark:text-neutral-text-dark text-sm font-medium leading-normal">
                                            {{ __('patient.penalties.action') }}
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td class="h-[72px] px-4 py-2">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span
                                                    ...
                                                    {{ __('patient.penalties.reason_types.late_cancellation') }}
                                                </span>
                                            </div>
                                        </td>
                                        <td
                                        ...
                                        <td class="h-[72px] px-4 py-2">
                                            <div class="flex flex-col">
                                                <span class="text-body-text dark:text-body-text-dark font-medium">
                                                    {{ __('patient.penalties.consequence_types.warning_issued') }}
                                                </span>
                                                <span class="text-neutral-text dark:text-neutral-text-dark text-xs">
                                                    {{ __('patient.penalties.consequence_types.no_charge') }}
                                                </span>
                                            </div>
                                        </td>
                                        <td class="h-[72px] px-4 py-2">
                                            <a href="#"
                                                ...
                                                {{ __('patient.penalties.view_details') }}
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr
                                        ...
                                        <td class="h-[72px] px-4 py-2">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span
                                                    ...
                                                    {{ __('patient.penalties.reason_types.missed_payment') }}
                                                </span>
                                            </div>
                                        </td>
                                        <td
                                        ...
                                        <td class="h-[72px] px-4 py-2">
                                            <div class="flex flex-col">
                                                ...
                                                <span class="text-neutral-text dark:text-neutral-text-dark text-xs">
                                                    {{ __('patient.penalties.consequence_types.cancellation_fee') }}
                                                </span>
                                            </div>
                                        </td>
                                        <td class="h-[72px] px-4 py-2">

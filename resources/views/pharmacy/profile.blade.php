                                ...
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            ...
                                            <p class="font-medium text-body-text dark:text-body-text-dark">{{ $empleado->sucursal->nombre ?? 'N/A' }}</p>
                                        </div>
                                        <div>
                                            <p class="text-sm text-neutral-text dark:text-neutral-text-dark">Cadena</p>
                                            <p class="font-medium text-body-text dark:text-body-text-dark">{{ $empleado->sucursal->cadena->nombre ?? 'N/A' }}</p>
                                        </div>
                                        <div>
                                            ...
                                            <p class="font-medium text-body-text dark:text-body-text-dark">
                                                ...
                                                @if($empleado->sucursal->numero_int ?? null), Int. {{ $empleado->sucursal->numero_int }}@endif
                                                <br>
                                        ...
                                        <div>
                                            ...
                                            <p class="font-medium text-body-text dark:text-body-text-dark">{{ $empleado->sucursal->contacto }}</p>
                                        </div>
                                        @endif
                                    </div>
                                </div>

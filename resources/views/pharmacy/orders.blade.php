...
@section('title', __('pharmacy.orders.title') . ' - Te Acerco Salud')

@section('pharmacy-main-class', 'flex flex-col overflow-hidden')
...
@section('pharmacy-content')
      ...
      <div class="flex-1 overflow-y-auto p-4 space-y-4" id="orders-list">
        @forelse ($pedidos as $index => $pedido)
          ...
          <div onclick="selectOrder(this, {{ $index }})"
            ...
            data-order-index="{{ $index }}" data-folio="{{ $pedido->getFolio() }}" data-estatus="{{ $estatusLower }}">
            <div class="flex items-start justify-between">
              <div>
                ...
                <p class="text-xs text-neutral-text dark:text-neutral-text-dark">
                  {{ __('pharmacy.orders.order_number') }} #{{ $pedido->getFolio() }}
                </p>
              </div>
  ...
  <div id="cancelOrderModal" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
    aria-modal="true">
    <!-- Backdrop -->
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div
        class="relative transform overflow-hidden rounded-2xl bg-card-light dark:bg-card-dark shadow-2xl transition-all w-full max-w-md">
        <!-- Modal Header -->
        ...
        <div class="px-6 py-4">
          <p class="text-sm text-neutral-text dark:text-neutral-text-dark mb-3">
            {{ __('pharmacy.orders.cancel_modal.question') }} <span id="modalOrderFolio"
              class="font-bold text-body-text dark:text-body-text-dark"></span>?
          </p>
          <div
            class="rounded-lg border border-warning/40 bg-warning/10 px-4 py-3 text-sm text-warning dark:border-warning/30 dark:bg-warning/15">

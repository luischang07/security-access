...
@section('content')
    @include('components.navbar', ['type' => 'landing', 'transparent' => true])
                    ...
                    <div class="flex flex-col gap-8 @[960px]:w-1/2 @[960px]:justify-center">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="{{ route('prescription.upload.step1') }}"
                                ...
                                <span class="truncate">{{ __('patient.landing.hero.cta_upload') }}</span>
                            </a>
                        </div>
                        <div class="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400 pt-2">
                            <span class="material-symbols-outlined text-secondary">verified_user</span>
                            <span>{{ __('patient.landing.hero.hipaa_compliant') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="text-center mb-12">
                    <h2
                        ...
                        {{ __('patient.landing.how_it_works.title') }}</h2>
                    <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">
                        {{ __('patient.landing.how_it_works.subtitle') }}</p>
                </div>
                <!-- TextGrid Component -->
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-1">
                            <h3 class="text-[#111418] dark:text-white text-lg font-bold leading-tight">
                                {{ __('patient.landing.how_it_works.step1_title') }}</h3>
                            <p class="text-gray-600 dark:text-gray-400 text-sm font-normal leading-normal">
                                {{ __('patient.landing.how_it_works.step1_desc') }}</p>
                        </div>
                    </div>
                    <div
                        class="flex flex-col gap-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-background-light dark:bg-background-dark p-6 text-center items-center">
                        ...
                        <div class="flex flex-col gap-1">
                            <h3 class="text-[#111418] dark:text-white text-lg font-bold leading-tight">
                                {{ __('patient.landing.how_it_works.step2_title') }}</h3>
                            <p class="text-gray-600 dark:text-gray-400 text-sm font-normal leading-normal">
                                {{ __('patient.landing.how_it_works.step2_desc') }}</p>
                        </div>
                    </div>
                    <div
                        class="flex flex-col gap-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-background-light dark:bg-background-dark p-6 text-center items-center">
                        ...
                        <div class="flex flex-col gap-1">
                            <h3 class="text-[#111418] dark:text-white text-lg font-bold leading-tight">
                                {{ __('patient.landing.how_it_works.step3_title') }}</h3>
                            <p class="text-gray-600 dark:text-gray-400 text-sm font-normal leading-normal">
                                {{ __('patient.landing.how_it_works.step3_desc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="lg:w-1/2 flex flex-col gap-6">
                        <div class="flex flex-col gap-4">
                            <h2
                                ...
                                {{ __('patient.landing.pharmacy_network.title') }}</h2>
                            <p class="text-gray-600 dark:text-gray-400 text-base font-normal leading-normal">
                                {{ __('patient.landing.pharmacy_network.description') }}</p>
                        </div>
                        <a href="{{ route('prescription.pharmacy-map') }}"
                            ...
                            <span class="truncate">{{ __('patient.landing.pharmacy_network.cta') }}</span>
                        </a>
                    </div>
        ...
        <section class="px-4 sm:px-10 lg:px-20 py-16 md:py-24 bg-white dark:bg-gray-900" id="benefits">
            <div class="max-w-6xl mx-auto">
                <div class="text-center mb-12">
                    <h2
                        class="text-[#111418] dark:text-white text-3xl font-bold leading-tight tracking-[-0.015em] sm:text-4xl">
                        {{ __('patient.landing.benefits.title') }}</h2>
                    <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">
                        {{ __('patient.landing.benefits.subtitle') }}</p>
                </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-[#111418] dark:text-white">
                                {{ __('patient.landing.benefits.save_time_title') }}</h3>
                            <p class="text-gray-600 dark:text-gray-400 mt-1">
                                {{ __('patient.landing.benefits.save_time_desc') }}</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="text-secondary mt-1">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-[#111418] dark:text-white">
                                {{ __('patient.landing.benefits.guaranteed_stock_title') }}</h3>
                            <p class="text-gray-600 dark:text-gray-400 mt-1">
                                {{ __('patient.landing.benefits.guaranteed_stock_desc') }}</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="text-secondary mt-1">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-[#111418] dark:text-white">
                                {{ __('patient.landing.benefits.easy_process_title') }}</h3>
                            <p class="text-gray-600 dark:text-gray-400 mt-1">
                                {{ __('patient.landing.benefits.easy_process_desc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="px-4 sm:px-10 lg:px-20 py-16 md:py-24">
            <div class="max-w-4xl mx-auto bg-primary/10 dark:bg-primary/20 p-8 sm:p-12 text-center rounded-xl">
                <h2 class="text-3xl sm:text-4xl font-bold text-[#111418] dark:text-white">
                    {{ __('patient.landing.cta_block.title') }}</h2>
                <p class="text-gray-600 dark:text-gray-300 mt-4 text-lg">
                    {{ __('patient.landing.cta_block.subtitle') }}</p>
                <a href="{{ route('register') }}"
                    ...
                    <span class="truncate">{{ __('patient.landing.cta_block.button') }}</span>
                </a>
            </div>
        </section>
    </main>

    @include('components.footer', ['type' => 'landing'])
@endsection

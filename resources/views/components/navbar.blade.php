    ...
    <div class="px-4 sm:px-10 lg:px-20 mx-auto">
      <div
        ...
        <a href="{{ route('landing') }}"
          ...
          <h2 class="text-xl font-bold leading-tight tracking-[-0.015em]">{{ __('common.brand') }}</h2>
        </a>
    ...
    <div class="px-4 sm:px-10 lg:px-20 mx-auto">
      <div
        ...
        <a href="{{ route('landing') }}"
          ...
          <h2 class="text-lg font-bold leading-tight tracking-[-0.015em]">{{ __('common.brand') }}</h2>
        </a>
